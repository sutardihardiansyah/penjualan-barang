	...
	<div class="card-body">
		<form action="<?= base_url('user/update'); ?>" method="post">
			...
			<div class="form-group col-md-6">
				...
				<input type="text" name="nama" id="nama" class="form-control <?= form_error('nama') ? 'is-invalid' : ''; ?>" value="<?= $user['nama']; ?>" required>
			...
			<div class="form-group col-md-6">
				...
				<input type="text" name="username" id="username" class="form-control <?= form_error('username') ? 'is-invalid' : ''; ?>" value="<?= $user['username']; ?>" required>
				<div class="invalid-feedback">
					<?= form_error('username'); ?>
				</div>
			</div>
			<div class="form-group col-md-6">
				...
				<input type="email" name="email" id="email" class="form-control <?= form_error('email') ? 'is-invalid' : ''; ?>" value="<?= $user['email']; ?>" required>
				<div class="invalid-feedback">
					<?= form_error('email'); ?>
				</div>
			</div>
